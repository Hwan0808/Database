...
( select department_name
  ...
  where d.location_id=l.location_id and country_id = 'US' );
...
--3번
CREATE VIEW OR REPLACE EMP_JOB_VW 
AS SELECT employee_id, first_name, job_title, department_id
...
--5번 
DROP VIEW EMP_JOB_VW;

--(인덱스)--

--1번
CREATE UNIQUE INDEX DEPT_NAME
